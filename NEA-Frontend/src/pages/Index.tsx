        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <Link to="/support" className="text-gray-700 hover:text-blue-600 font-medium">Feedback</Link>
...
{/** 
<Link to="/profile">
  <Button variant="outline" className="border-blue-600 text-blue-600 hover:bg-blue-50 ml-2">
    Profile
  </Button>
</Link>
*/}
